  ...
  return (
    <section className="flex flex-col justify-around items-center gap-6 px-8 py-1 lg:flex-row h-screen">
      <div className="flex flex-col justify-center text-center lg:py-12 lg:text-left lg:w-1/2 xl:py-24">
        <p className="mb-4 font-bold text-white md:text-lg xl:text-xl cartoonic">
          Blast off on an interstellar odyssey!
        </p>
        <h1 className="mb-4 text-1xl font-bold text-white md:text-3xl cartoonic">
      ...
      <div className="lg:h-auto lg:w-1/6 res">
        <img
          src={HERO_IMAGE}
          alt="Star"
